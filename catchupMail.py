            ...
            message.add_alternative(
                "".join(
                    (
                        ...
                        link,
                        "</p><br/><p>You can manage your alerts at <a href='http://galaxyharvester.net/myAlerts.py'>http://galaxyharvester.net/myAlerts.py</a></p><p>-Galaxy Harvester Administrator</p>",
                    )
                ),
                subtype="html",
            )
...
def retryPendingMail(conn, emailIndex):
    ...
    while row != None:
        ...
        result = sendAlertMail(
            conn, row[0], alertBody, row[3], row[4], alertTitle, emailIndex
        )
        if result == 1:

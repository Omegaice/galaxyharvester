...
def renderFeed(path):
    ...
    print(
        "<description>Latest additions to Galaxy Harvester resource listing</description>"
    )
    ...
    if cursor:
        ...
        while row != None:
            ...
            print(
                "<link>http://galaxyharvester.net/resource.py/"
                + str(row[2])
                + "/"
                + row[1]
                + "</link>"
            ...
            print(
                '<guid isPermalink="true">http://galaxyharvester.net/resource.py/'
                + str(row[2])
                + "/"
                + row[1]
                + "</guid>"

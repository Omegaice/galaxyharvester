...
class testObjects(unittest.TestCase):
    ...
    def test_recipeRender(self):
        ...
        i1 = ghObjectRecipe.recipeIngredient(
            "steel_kiirium",
            "17895",
            "armor_layer_weld_tabs",
            8,
            "0",
            "Kiirium Steel",
            455,
        ...
        i2 = ghObjectRecipe.recipeIngredient(
            "copper_polysteel",
            "13455",
        ...
        self.assertIn(
            "yellow", slotHTML, "Expected quality color not present in slot HTML."
        )
